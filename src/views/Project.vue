...
export default {
    ...
    data() {
        return {
            //状态值
            projectStates: [
                {projectState: "未完成", type: ''},
                {projectState: '完成', type: 'success'},
                {projectState: '状态3', type: 'info'},
                {projectState: '状态4', type: 'warning'},
                {projectState: '状态5', type: 'danger'}
            ],
            /**
